...
Shopify.removeListener = function(target, type, listener) {
  target.removeEventListener ? target.removeEventListener(type, listener) : target.detachEvent('on'+type, listener);
};
